...
Make dirty row table headers clickable to sort by
Find a way to bin all string values 
Only show a subset of the clean data but show all dirty data. Bin by clean or error type
Python script it currently hard-coded, how to make dynamic as wranglers are added?
Add visualizations as modules. 
List of small tasks: 
