...
from app.server_utils.service_helpers import is_categorical, get_error_dist
...
class DataProfile:
    ...
    def calculate_column_attribute(self, attribute_name, column_name):
        look_up_value = self.look_up_stat(self, attribute_name, column_name)
        # TODO: add asserts to make sure that attribute is compatible with the type of the column
        if look_up_value is not None:
            return look_up_value

        calculate_attribute_func = self.name_to_func[attribute_name]
        return calculate_attribute_func(column_name)
    ...
    def calculate_mean(self, column_name):
        try:
            ...
            avg = self.main_df[column_name].mean()
    ...
    def calculate_median(self, column_name):
        try:
            ...
            median = self.main_df[column_name].median()
    ...
    def calculate_max(self, column_name):
        try:
            ...
            maximum = self.main_df[column_name].max()
    ...
    def calculate_min(self, column_name):
        try:
            ...
            minimum = self.main_df[column_name].min()
    ...
    def calculate_num_categories(self, column_name):
        try:
            ...
            n_categories = fetch_sql(query, False, self.engine)
        except Exception as e:
            ...
            n_categories = self.main_df[column_name].nunique()
    ...
    def calculate_mode(self, column_name):
        ...
        mode = self.main_df[column_name].mode()
