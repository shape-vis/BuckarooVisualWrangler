...
export default function FilterModal({ visible, attribute, onClose, onApply, table_name, errorColors }) {
  return (
    <Modal visible={visible}>
        ...
        <HistogramBarChart attribute={attribute}  cellID={"filterModalHistogram"}  xPos={50} yPos={20} size={300} table_name={table_name} attrX={attribute}  errorColors={errorColors} />
        </svg>
